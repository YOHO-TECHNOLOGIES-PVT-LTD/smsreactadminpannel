  ...
  const [cities, setCities] = useState<City[]>([
    {
      ...
      serviceCenters: [
        ...
        "Vadapalani", "Chennai Central", "Perungudi", "Ashok Nagar",
        "Mylapore", "Nungambakkam", "Thiruvanmiyur", "Kotturpuram",
      ],
    },
    {
      name: "Madurai",
    ...
    setCities(prevCities =>
      prevCities.map(city =>
        city.name === cityName
          ? {
              ...city,
              serviceCenters: city.serviceCenters?.filter(c => c !== centerName),
            }
          : city
      )
    );
    ...
    <div className='px-2 mt-2 space-y-6'>
      ...
      {exactMatchCity && (
        <div className='mt-4'>
          ...
          {exactMatchCity.serviceCenters && exactMatchCity.serviceCenters.length > 0 ? (
                ...
                {exactMatchCity.serviceCenters.map((center, idx) => (
                  <tr key={idx} className='border-t hover:bg-gray-100 text-center'>
                    ...
                    <td className='px-4 py-2'>
					  ...
					  <button
                        onClick={() => handleDeleteServiceCenter(exactMatchCity.name, center)}
