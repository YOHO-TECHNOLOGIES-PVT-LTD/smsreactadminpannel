        ...
        <div className="w-2/3">
          <form className="mx-auto pl-96">
            ...
            <div className="relative">
              ...
              <button type="submit" className="text-white absolute end-2.5 bottom-2.5 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2  dark:focus:ring-blue-800" style={{ backgroundColor: "#9b111e" }}>Search</button>
            </div>
          </form>
        </div>
      </div>

      <div className="flex items-center p-2"><button onClick={onSpareParts} className="ml-auto px-4 py-2 bg-green-500 text-white rounded-md" style={{ background: "linear-gradient(44.99deg,#700808 11%,#d23c3c 102.34%)" }}>Spares</button></div>
        ...
        <div>
          <div className="w-full w-5/6 p-4 bg-white border border-gray-200 rounded-lg shadow-sm sm:p-8 dark:border-gray-700">
            <div className="flex items-center justify-between mb-4 cursor-pointer" >
              ...
              <span className="text-sm font-medium text-orange-800 hover:underline dark:text-orange-800" onClick={() => setIsOpen(!isOpen)}>
            ...
            {isOpen && (
              <div className="overflow-x-auto ">
                <button type="button" className="text-white font-medium rounded-lg text-sm px-3 py-1 mt-2  flex ml-auto me-2 mb-2 focus:outline-none" style={{ background: "linear-gradient(44.99deg,#700808 11%,#d23c3c 102.34%)" }}>Add</button>
                <table className="min-w-full text-left text-sm font-light text-gray-900 dark:text-black">
                  <thead className="border-b font-medium dark:border-gray-700 dark:text-black">
                    <tr className="">
                  ...
                  <tbody>
                    {serviceOptions.map((option, index) => (
                      <tr key={index} className="border-b dark:border-gray-700">
                        <td className="px-0 py-0 text-2xl font-normal"><img src={option.image} alt="image" className="w-2/3 h-12" /></td>
                        ...
                        <td className="px-4 py-2">
                          <label className="inline-flex items-center cursor-pointer">
                            ...
                            <div className="relative w-9 h-5 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600 dark:peer-checked:bg-blue-600"></div>
                          </label>
                        </td>
                      </tr>
                    ))}
