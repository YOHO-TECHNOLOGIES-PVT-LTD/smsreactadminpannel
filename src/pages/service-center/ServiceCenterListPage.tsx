							...
							<div key={index}>
								<div className='bg-white p-6 rounded-lg shadow flex flex-col sm:flex-row gap-20 items-start w-full max-w-[2000px]'>
									...
									<div className='flex-1'>
										...
										<p
											className='text-sm text-gray-500 mt-1 border-[1px] border-[#800000] bg-[#F9E6E6] px-2 py-1 rounded inline-block w-fit mt-5'
											style={{ ...FONTS.subParagraph }}
										>
											{center.contact_info.address1},{' '}
											{center.contact_info.address2}, {center.contact_info.city}
										</p>
									</div>
