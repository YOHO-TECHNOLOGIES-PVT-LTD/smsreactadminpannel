...
export const JobCardsPage: React.FC = () => {
	...
	const filteredInvoices = invoices.filter((invoice) => {
		...
		return (
			...
			invoice.customerInfo.contactNo?.toLowerCase().includes(query) ||
			false || // Added phone number to search
										...
										<td className='px-4 py-3 border-b font-semibold'>
											<div className='flex justify-center gap-3'>
												...
												{[
													...
													'completed',
													'Billing',
												].includes(invoice.status?.trim().toLowerCase()) ? (
					...
					<div className='bg-white rounded-xl w-full max-w-6xl max-h-[90vh] overflow-y-auto scrollbar-hide'>
                      ...
                      >
						...
						<div className='p-6 space-y-6'>
							...
							<div className='border rounded-lg p-4'>
								...
								<div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 text-sm'>
									...
									<div>
										...
										<p className='font-medium'>
											{selectedInvoice.partnerId.contact_info.phoneNumber ||
												'N/A'}
										</p>
									</div>
									{/* <div>
								...
								<div className='space-y-4'>
									<div>
										...
										<p
											...
											style={{ ...FONTS.subParagraph }}
										>
											{selectedInvoice.serviceInfo.customerComplaint ||
									...
									<div>
										...
										<p
											...
											style={{ ...FONTS.subParagraph }}
										>
											{selectedInvoice.serviceInfo.actionToBeTaken ||
												'No action specified'}
										</p>
									</div>
								</div>
							...
							{/* Spare Items */}
							{selectedInvoice.serviceInfo.products &&
								selectedInvoice.serviceInfo.products.length > 0 && (
									<div className='border rounded-lg p-4'>
										<h3
											className='mb-4'
											style={{ ...FONTS.header, fontWeight: 500 }}
										...
										<div className='space-y-2'>
											{selectedInvoice.serviceInfo.products.map(
												(item, index) => (
													<div
														key={index}
							...
							{/* Service Items */}
							{selectedInvoice.serviceInfo.services &&
								selectedInvoice.serviceInfo.services.length > 0 && (
									<div className='border rounded-lg p-4'>
										<h3
											className='mb-4'
											style={{ ...FONTS.header, fontWeight: 500 }}
										...
										<div className='space-y-2'>
											{selectedInvoice.serviceInfo.services.map(
												(item, index) => (
													<div
														key={index}
														className='flex justify-between items-center py-2 border-b border-gray-100'
