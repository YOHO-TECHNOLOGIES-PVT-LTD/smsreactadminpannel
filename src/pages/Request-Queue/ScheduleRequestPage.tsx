...
export default function ScheduleRequestPage() {
  ...
  const assignPartner = async () => {
    ...
    const selectedPartner = partners.find(p => p._id === selectedPartnerId);
     console.log("Socket status before emit:", socket?.connected);
    console.log("partnerId", selectedPartnerId)
    ...
    const partnerNotification = {
      title: "New Scheduled Service Assigned",
      message: `You have been assigned a service...`,
      type: "info",
      priority: "medium",
      recipient_type: "partner",
      recipient_id: selectedPartner?._id,
      is_read: false,
      is_active: true,
      is_sent: false, 
